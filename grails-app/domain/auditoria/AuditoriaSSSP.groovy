...
class AuditoriaSSSP implements Serializable {
    ...
    static mapping = {
        ...
        table 'auditoria_movimientos'
        id(generator: 'sequence', params: [sequence: 'auditoria_movimientos_id_seq'])
